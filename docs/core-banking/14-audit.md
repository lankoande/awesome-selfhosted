...
| 18 | **Crédit** | Comité de crédit à plus de deux yeux ; passage en perte (`WRITTEN_OFF` sans opération) ; recouvrement et contentieux ; révision de taux (`RATE_REVISION` sans service) ; différé total ; échéances irrégulières ; réalisation de sûreté | Tout le reste du cycle, mesuré |
