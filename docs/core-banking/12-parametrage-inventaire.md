...
| `kyc_policy` / `kyc_policy_document` | Politique de diligence par nature de tiers et niveau : pièces exigées, bénéficiaires effectifs requis, seuil de détention, à deux ; une seule par couple, elle se remplace |
