...
testés : [`../../core-banking`](../../core-banking) — Java 21, PostgreSQL, **697 tests verts**. Le dossier ci-dessous reste la référence de conception ;
...
| 17 | [**Prise en main pour les développeurs**](17-prise-en-main.md) | Démarrer, la carte du dépôt, les huit règles à connaître, ajouter un module ou une migration, ce qu'il faut lancer avant de pousser |
| 16 | [Back-office agence](16-back-office.md) | Décisions d'architecture front, sécurité, configurabilité, thèse de design, garde-fous — puis, écran par écran, ce que la construction a tranché et les lacunes de contrat qu'elle a trouvées |
| — | [**Guide de l'utilisateur**](utilisateur/README.md) | Le back-office vu du comptoir : prise en main, espèces, virement, relevé, arrêté de caisse, validation, clients, crédit, siège, et le lexique des refus |
