...
class OperationCoverageTest {
    ...
    private static final Map<String, Operation> ENTRY_POINTS = Map.ofEntries(
        ...
        Map.entry("TermDepositService.subscribe", Operation.TERM_DEPOSIT_SUBSCRIBE),
        Map.entry("TermDepositService.breakEarly", Operation.TERM_DEPOSIT_BREAK),
        ...
        Map.entry("TaxRules.declare", Operation.TAX_RULE_MANAGE),
        Map.entry("StatementPacks.declare", Operation.STATEMENT_PACK_MANAGE),
        Map.entry("ConsolidationScopes.declare / eliminate", Operation.CONSOLIDATION_MANAGE),
    ...
    void money_and_debt_require_a_second_person() {
        for (Operation operation : EnumSet.of(Operation.LOAN_DISBURSE, Operation.LOAN_RESCHEDULE,
                                              ...
                                              Operation.TERM_DEPOSIT_SUBSCRIBE,
                                              Operation.TERM_DEPOSIT_BREAK,
                                              ...
                                              Operation.STATEMENT_PACK_MANAGE,
                                              Operation.CONSOLIDATION_MANAGE,
