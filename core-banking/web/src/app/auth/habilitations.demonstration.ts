...
const POLITIQUE: readonly Ligne[] = [
  ...
  ['PRODUCT_CLOSE', 'OWN_ENTITY', true, false],
  ['PRODUCT_READ', 'OWN_ENTITY'],
  ['CHART_OF_ACCOUNTS_READ', 'OWN_ENTITY'],
  ['ACCOUNTING_SCHEMA_READ', 'OWN_ENTITY'],
  ['ACCOUNTING_SCHEMA_CLOSE', 'OWN_ENTITY', true, false],
  ...
  ['STATEMENT_LAYOUT_READ', 'OWN_ENTITY'],
  ['STATEMENT_LAYOUT_CLOSE', 'OWN_ENTITY', true, false],
  ['CALENDAR_MANAGE', 'OWN_ENTITY', true, false],
  ['CALENDAR_READ', 'OWN_ENTITY'],
  ['BRANCH_READ', 'OWN_ENTITY'],
