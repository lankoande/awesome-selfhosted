...
/**
 * La cloture annuelle (TFA) : elle determine le resultat, clot le dernier mois et l'exercice.
 * Lancement, reprise et annulation a deux ; l'annulation se date de la fin d'exercice.
 */
@RestController
@RequestMapping("/v1/entities/{legalEntityId}/eoy/runs")
public class YearEndController {
    ...
    public YearEndController(UseCaseExecutor executor, EodEngines engines,
                             MakerChecker makerChecker) {
        this.executor = executor;
        this.makerChecker = makerChecker;
        this.read = new PeriodEndUseCases.Read(engines, RunType.TFA);
    }
    ...
    public MakerChecker.View run(Caller caller, @PathVariable UUID legalEntityId,
        ...
        return makerChecker.submit(caller, legalEntityId, "TFA_RUN",
    ...
    public MakerChecker.View resume(Caller caller, @PathVariable UUID legalEntityId,
        ...
        return makerChecker.submit(caller, legalEntityId, "TFA_RESUME",
    ...
    public MakerChecker.View cancel(Caller caller, @PathVariable UUID legalEntityId,
        ...
        return makerChecker.submit(caller, legalEntityId, "TFA_CANCEL", Payloads.of(
