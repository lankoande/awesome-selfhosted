...
| | |
|---|---|
| **Socle** | Fonctionnellement complet — **696 tests verts**, dont l'API de bout en bout sur PostgreSQL réel |
| **Back-office** | 9 écrans sur 11 — **132 tests**, conformes à sept largeurs d'écran |
| **Documentation** | 17 documents de conception + un guide utilisateur illustré |
...
```
core-banking/        Le socle : 22 modules Maven
  schema-db/           Les montées de version : 56 scripts SQL, un changelog Liquibase
