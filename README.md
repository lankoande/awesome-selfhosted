...
| | |
|---|---|
| **Socle** | Fonctionnellement complet — **761 tests verts**, dont l'API de bout en bout sur PostgreSQL réel |
| **Back-office** | Guichet, validation, caisse, siège, clients, crédit, paiements, conformité et réglementaire — **40 écrans, 564 tests**, conformes à sept largeurs, habilitations lues à la granularité de l'action |
