...
**~215 s** pour les 697 tests du socle, **~100 s** pour le front (243 tests, compilation,
vingt-neuf adresses à sept largeurs), **< 1 s** pour les liens. Un coureur part d'un cache
